...
const Expertise = () => {
  const [expertiseData, setExpertiseData] = useState([
    ...
    {
      icon: partLogo,
      title: "Back-end: Powering Your Platform Behind the Scenes.",
      description:
    ...
    {
      icon: Vector1,
      title: "Revolutionizing Mobility: Your Vision, Our Expertise!",
      description:
    ...
    {
      icon: Vector2,
      title: "Project Management: Steering Your Success.",
      description:
