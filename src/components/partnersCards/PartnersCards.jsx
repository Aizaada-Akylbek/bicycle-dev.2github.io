...
import HTP from "../../assets/partners/Copy_of_htpkr_logo.png";
...
const PartnersCards = () => {
  ...
  const cardData = [
    {
      ...
      bg: Kamasys,
      info: t(
        "Kamasys is a German market-leading software company in the field of communal catering, operating since 2003. Within 20 years of market experience, kamasys has built up a broad portfolio of innovative products in cash register, payment systems and digital labeling in food industry."
      ),
      link: "https://www.kamasys.de/en/",
      width: 48,
      linkTitle: "Startseite - kamasys",
    },
    {
      title: "MK Logic GmbH",
      bg: GmbH,
      ...
      link: "https://www.mk-logic.de/",
      width: 48,
      linkTitle: "MK Logic | Home (mk-logic.de)",
    },
    {
      title: "Osma Group",
      bg: Osma,
      ...
      link: "https://osmagroup.org/#/",
      width: 100,
      linkTitle: "OSMA GROUP",
    },
    {
      title: "The High Technologies Park of the Kyrgyz Republic ",
      link: "http://htp.kg/",
      bg: HTP,
      info: t(
  ...
  return (
    <div className="partners-cards">
      ...
      {cardData.map((el) => (
        <div
          className="partners-card dark-blue"
